/*
 * C-Script file for: 28379D/Control Corriente
...
{
   h = ParamRealData(0,0);
   Vdc = ParamRealData(1,0);
   R = ParamRealData(2,0);
   w = ParamRealData(3,0);
   R1 = ParamRealData(4,0);
   //id_r = ParamRealData(5,0);
   //iq_r = ParamRealData(6,0);
   e = ParamRealData(5,0);
   L1 = ParamRealData(6,0);
   L2 = ParamRealData(7,0);
   Cf = ParamRealData(8,0);
   //Vcd_r = ParamRealData(11,0);
   //Vcq_r = ParamRealData(12,0);
   d1_L1C = ParamRealData(9,0);
   d1_L2 = ParamRealData(10,0);
   d1_C2 = ParamRealData(11,0);
   Vgd_r = ParamRealData(12,0);
   Vgq_r = ParamRealData(13,0);
   d1_L1 = ParamRealData(14,0);
   d1_c = ParamRealData(15,0);
}
